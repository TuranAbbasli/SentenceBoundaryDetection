...
from encoders import CharacterEncoder, CharacterEncoderProtocol
from configs import SegmenterConfig, MetricsResult
from models import TextSegmentationModel, create_model, ModelIO
from seperator import SentenceSegmenter
...
# from models import create_model, TextSegmentationModel

# from segmenters.types import SegmenterConfig, MetricsResult
# from segmenters.model_io import ModelIO
# from segmenters.sentences import SentenceSegmenter
# from segmenters.paragraphs import ParagraphSegmenter
# from segmenters.spans import SpanHandler
# from segmenters.evaluation import Evaluator

PATTERN_CONFIDENCE_THRESHOLD = 0.8
CACHE_USE_THRESHOLD = 50
...
class TextSegmenter:
    ...
    def _predict_for_position(
        ...
        features = self.feature_extractor._get_char_features_numpy(
            context,
